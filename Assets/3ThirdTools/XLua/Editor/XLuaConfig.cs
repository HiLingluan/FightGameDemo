...
//    /***************如果你全lua编程，可以参考这份自动化配置***************/  阅读转Lua后再整理这里
//    //--------------begin 纯lua编程配置参考----------------------------
...
//        typeof(PreloadTools),
//        typeof(SceneMgr),
//        typeof(GlobalObjectMgr),
//        typeof(LocalConfig),
//        typeof(UIClickBase),
//        typeof(MouseClickBase),
//        typeof(UILocalPositionRecord),
//        typeof(Utility),
//        typeof(SDKHelper),
//        typeof(SDKHelperForIOS),
//        typeof(EventGuideTarget),
//        typeof(LoggerHelper),
//        typeof(ZipDownloadTools),
//        typeof(ImageProxy),
//        typeof(RawImageProxy),
//        typeof(SpriteRenderProxy),
//        typeof(LuaDataProxy),
//        typeof(UIGray),
//        typeof(CSNetUrlConfig),
//        typeof(UICommonTools),

//        //--------------Logic-----------------
//        typeof(ReadService),
//        typeof(MaleController),
//        typeof(StoryDataMgr),
//        typeof(VReadPanel),
//        typeof(ReadInfo),
...
//        typeof (IAwaiter<int>),
//        typeof (ILuaTask<int>),
//        typeof(Action<string, SPointerData>),
//        typeof(Action<SPointerData>),
//        typeof(Func<IWindow, IWindow, ActionType>),     //window Overlay打开规则重写接口
//        typeof(Func<LoopListView2, int, LoopListViewItem2>),
//        typeof(Action<TMP_TextInfo>),
//        typeof(Action<PointerEventData>),
//        typeof(Action<IWindow>),
//        typeof(Action<IView>),
//        typeof(IWindowData),
//        typeof(LuaWindowData),
//        typeof(WindowType),
//        typeof(WindowInfo),
//    };
