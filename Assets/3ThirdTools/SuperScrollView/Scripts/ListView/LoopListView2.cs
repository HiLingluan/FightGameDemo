...
namespace SuperScrollView
{
    ...
    public class LoopListView2 : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler,IPointerClickHandler
    {
        ...
        public RectTransform mScrollRectTransform = null;
        ...
        public Action<PointerEventData> mOnBeginDragAction = null;
        public Action<PointerEventData> mOnDragingAction = null;
        public Action<PointerEventData> mOnEndDragAction = null;
        public Action<PointerEventData> mOnClickAction = null;

        public Action<float> mOnContentSizeChange = null;
        ...
        */
            ...
            LoopListViewInitParam initParam = null)
        {
            ...
            mViewImage = mScrollRect.viewport.GetComponent<Image>();
        ...
        */
        ...
        public virtual void OnBeginDrag(PointerEventData eventData)
        {
            ...
            mCurSnapData.Clear();
            mOnBeginDragAction?.Invoke(eventData);
        }
        ...
        public virtual void OnEndDrag(PointerEventData eventData)
        {
            ...
            mOnEndDragAction?.Invoke(eventData);
            ForceSnapUpdateCheck();
        }
        ...
        public virtual void OnDrag(PointerEventData eventData)
        {
            ...
            CacheDragPointerEventData(eventData);
            mOnDragingAction?.Invoke(eventData);
        }

        public virtual void OnPointerClick(PointerEventData eventData)
        {
            mOnClickAction?.Invoke(eventData);
        }
        ...
        void UpdateContentSize()
        {
            ...
            if (size != oldSize)
            {
                mOnContentSizeChange?.Invoke(size);
                oldSize = size;
            }
            if (mIsVertList)
            {
