...
namespace XLua.CSObjectWrap
{
    ...
    public class ZFightDRSceneWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(ZFight.DRScene);
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "BackgroundMusicId", _g_get_BackgroundMusicId);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new ZFight.DRScene();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to ZFight.DRScene constructor!");
        ...
        static int _m_ParseDataRow(RealStatePtr L)
        {
		    try {
                ...
                ZFight.DRScene gen_to_be_invoked = (ZFight.DRScene)translator.FastGetCSObj(L, 1);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to ZFight.DRScene.ParseDataRow!");
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_BackgroundMusicId(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                ZFight.DRScene gen_to_be_invoked = (ZFight.DRScene)translator.FastGetCSObj(L, 1);
                LuaAPI.xlua_pushinteger(L, gen_to_be_invoked.BackgroundMusicId);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
