...
namespace XLua.CSObjectWrap
{
    ...
    public class ZFightThrusterDataWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(ZFight.ThrusterData);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 5 && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4) && translator.Assignable<ZFight.CampType>(L, 5))
				{
					...
					var gen_ret = new ZFight.ThrusterData(_entityId, _typeId, _ownerId, _ownerCamp);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to ZFight.ThrusterData constructor!");
        ...
        static int _g_get_Speed(RealStatePtr L)
        {
		    try {
                ...
                ZFight.ThrusterData gen_to_be_invoked = (ZFight.ThrusterData)translator.FastGetCSObj(L, 1);
