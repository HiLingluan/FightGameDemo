...
namespace XLua.CSObjectWrap
{
    ...
    public class ZFightDRSoundWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(ZFight.DRSound);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new ZFight.DRSound();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to ZFight.DRSound constructor!");
        ...
        static int _m_ParseDataRow(RealStatePtr L)
        {
		    try {
                ...
                ZFight.DRSound gen_to_be_invoked = (ZFight.DRSound)translator.FastGetCSObj(L, 1);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to ZFight.DRSound.ParseDataRow!");
