...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineEventSystemsIUpdateSelectedHandlerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			System.Type type = typeof(UnityEngine.EventSystems.IUpdateSelectedHandler);
        ...
        static int _m_OnUpdateSelected(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.EventSystems.IUpdateSelectedHandler gen_to_be_invoked = (UnityEngine.EventSystems.IUpdateSelectedHandler)translator.FastGetCSObj(L, 1);
