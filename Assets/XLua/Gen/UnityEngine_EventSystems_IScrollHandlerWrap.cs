...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineEventSystemsIScrollHandlerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			System.Type type = typeof(UnityEngine.EventSystems.IScrollHandler);
        ...
        static int _m_OnScroll(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.EventSystems.IScrollHandler gen_to_be_invoked = (UnityEngine.EventSystems.IScrollHandler)translator.FastGetCSObj(L, 1);
