...
namespace XLua.CSObjectWrap
{
    ...
    public class ZFightAccessoryObjectDataWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(ZFight.AccessoryObjectData);
        ...
        {
            return LuaAPI.luaL_error(L, "ZFight.AccessoryObjectData does not have a constructor!");
        }
        ...
        static int _g_get_OwnerId(RealStatePtr L)
        {
		    try {
                ...
                ZFight.AccessoryObjectData gen_to_be_invoked = (ZFight.AccessoryObjectData)translator.FastGetCSObj(L, 1);
