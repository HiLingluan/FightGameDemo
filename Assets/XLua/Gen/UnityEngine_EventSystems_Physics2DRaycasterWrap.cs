...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineEventSystemsPhysics2DRaycasterWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			System.Type type = typeof(UnityEngine.EventSystems.Physics2DRaycaster);
        ...
        static int _m_Raycast(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.EventSystems.Physics2DRaycaster gen_to_be_invoked = (UnityEngine.EventSystems.Physics2DRaycaster)translator.FastGetCSObj(L, 1);
