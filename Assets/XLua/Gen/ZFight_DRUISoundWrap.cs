...
namespace XLua.CSObjectWrap
{
    ...
    public class ZFightDRUISoundWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(ZFight.DRUISound);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new ZFight.DRUISound();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to ZFight.DRUISound constructor!");
        ...
        static int _m_ParseDataRow(RealStatePtr L)
        {
		    try {
                ...
                ZFight.DRUISound gen_to_be_invoked = (ZFight.DRUISound)translator.FastGetCSObj(L, 1);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to ZFight.DRUISound.ParseDataRow!");
