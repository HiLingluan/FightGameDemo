...
namespace XLua.CSObjectWrap
{
    ...
    public class ZFightDREntityWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(ZFight.DREntity);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new ZFight.DREntity();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to ZFight.DREntity constructor!");
        ...
        static int _m_ParseDataRow(RealStatePtr L)
        {
		    try {
                ...
                ZFight.DREntity gen_to_be_invoked = (ZFight.DREntity)translator.FastGetCSObj(L, 1);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to ZFight.DREntity.ParseDataRow!");
