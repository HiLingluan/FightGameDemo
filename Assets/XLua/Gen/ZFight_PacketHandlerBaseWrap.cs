...
namespace XLua.CSObjectWrap
{
    ...
    public class ZFightPacketHandlerBaseWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(ZFight.PacketHandlerBase);
        ...
        {
            return LuaAPI.luaL_error(L, "ZFight.PacketHandlerBase does not have a constructor!");
        }
        ...
        static int _m_Handle(RealStatePtr L)
        {
		    try {
                ...
                ZFight.PacketHandlerBase gen_to_be_invoked = (ZFight.PacketHandlerBase)translator.FastGetCSObj(L, 1);
