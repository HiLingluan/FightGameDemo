...
namespace XLua.CSObjectWrap
{
    ...
    public class ZFightDialogParamsWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(ZFight.DialogParams);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new ZFight.DialogParams();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to ZFight.DialogParams constructor!");
        ...
        static int _g_get_Mode(RealStatePtr L)
        {
		    try {
                ...
                ZFight.DialogParams gen_to_be_invoked = (ZFight.DialogParams)translator.FastGetCSObj(L, 1);
