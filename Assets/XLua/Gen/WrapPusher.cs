...
namespace XLua
{
    public partial class ObjectTranslator
    {
        ...
        class IniterAdderUnityEngineVector2
        {
			...
			static void Init(LuaEnv luaenv, ObjectTranslator translator)
			{
				...
				translator.RegisterPushAndGetAndUpdate<ZFight.PacketType>(translator.PushZFightPacketType, translator.Get, translator.UpdateZFightPacketType);
				translator.RegisterPushAndGetAndUpdate<ZFight.CampType>(translator.PushZFightCampType, translator.Get, translator.UpdateZFightCampType);
				translator.RegisterPushAndGetAndUpdate<ZFight.RelationType>(translator.PushZFightRelationType, translator.Get, translator.UpdateZFightRelationType);
				translator.RegisterPushAndGetAndUpdate<ZFight.GameMode>(translator.PushZFightGameMode, translator.Get, translator.UpdateZFightGameMode);
				translator.RegisterPushAndGetAndUpdate<ZFight.UIFormId>(translator.PushZFightUIFormId, translator.Get, translator.UpdateZFightUIFormId);
        ...
        int ZFightPacketType_TypeID = -1;
		int ZFightPacketType_EnumRef = -1;
        
        public void PushZFightPacketType(RealStatePtr L, ZFight.PacketType val)
        {
            if (ZFightPacketType_TypeID == -1)
            {
			    bool is_first;
                ZFightPacketType_TypeID = getTypeId(L, typeof(ZFight.PacketType), out is_first);
				
				if (ZFightPacketType_EnumRef == -1)
				{
				    Utils.LoadCSTable(L, typeof(ZFight.PacketType));
				    ZFightPacketType_EnumRef = LuaAPI.luaL_ref(L, LuaIndexes.LUA_REGISTRYINDEX);
				}
				
            }
			
			if (LuaAPI.xlua_tryget_cachedud(L, (int)val, ZFightPacketType_EnumRef) == 1)
            {
			    return;
			}
			
            IntPtr buff = LuaAPI.xlua_pushstruct(L, 4, ZFightPacketType_TypeID);
            if (!CopyByValue.Pack(buff, 0, (int)val))
            {
                throw new Exception("pack fail fail for ZFight.PacketType ,value="+val);
            }
			
			LuaAPI.lua_getref(L, ZFightPacketType_EnumRef);
			LuaAPI.lua_pushvalue(L, -2);
			LuaAPI.xlua_rawseti(L, -2, (int)val);
			LuaAPI.lua_pop(L, 1);
        ...
        public void Get(RealStatePtr L, int index, out ZFight.PacketType val)
        {
		    LuaTypes type = LuaAPI.lua_type(L, index);
            if (type == LuaTypes.LUA_TUSERDATA )
            {
			    if (LuaAPI.xlua_gettypeid(L, index) != ZFightPacketType_TypeID)
				{
				    throw new Exception("invalid userdata for ZFight.PacketType");
				}
                ...
                if (!CopyByValue.UnPack(buff, 0, out e))
                {
                    throw new Exception("unpack fail for ZFight.PacketType");
                }
				val = (ZFight.PacketType)e;
                
            }
            else
            {
                val = (ZFight.PacketType)objectCasters.GetCaster(typeof(ZFight.PacketType))(L, index, null);
            }
        }
		
        public void UpdateZFightPacketType(RealStatePtr L, int index, ZFight.PacketType val)
        {
            ...
            if (LuaAPI.lua_type(L, index) == LuaTypes.LUA_TUSERDATA)
            {
                ...
                if (!CopyByValue.Pack(buff, 0,  (int)val))
                {
                    throw new Exception("pack fail for ZFight.PacketType ,value="+val);
                }
            }
        ...
        int ZFightCampType_TypeID = -1;
		int ZFightCampType_EnumRef = -1;
        
        public void PushZFightCampType(RealStatePtr L, ZFight.CampType val)
        {
            if (ZFightCampType_TypeID == -1)
            {
			    bool is_first;
                ZFightCampType_TypeID = getTypeId(L, typeof(ZFight.CampType), out is_first);
				
				if (ZFightCampType_EnumRef == -1)
				{
				    Utils.LoadCSTable(L, typeof(ZFight.CampType));
				    ZFightCampType_EnumRef = LuaAPI.luaL_ref(L, LuaIndexes.LUA_REGISTRYINDEX);
				}
				
            }
			
			if (LuaAPI.xlua_tryget_cachedud(L, (int)val, ZFightCampType_EnumRef) == 1)
            {
			    return;
			}
			
            IntPtr buff = LuaAPI.xlua_pushstruct(L, 4, ZFightCampType_TypeID);
            if (!CopyByValue.Pack(buff, 0, (int)val))
            {
                throw new Exception("pack fail fail for ZFight.CampType ,value="+val);
            }
			
			LuaAPI.lua_getref(L, ZFightCampType_EnumRef);
			LuaAPI.lua_pushvalue(L, -2);
			LuaAPI.xlua_rawseti(L, -2, (int)val);
			LuaAPI.lua_pop(L, 1);
        ...
        public void Get(RealStatePtr L, int index, out ZFight.CampType val)
        {
		    LuaTypes type = LuaAPI.lua_type(L, index);
            if (type == LuaTypes.LUA_TUSERDATA )
            {
			    if (LuaAPI.xlua_gettypeid(L, index) != ZFightCampType_TypeID)
				{
				    throw new Exception("invalid userdata for ZFight.CampType");
				}
                ...
                if (!CopyByValue.UnPack(buff, 0, out e))
                {
                    throw new Exception("unpack fail for ZFight.CampType");
                }
				val = (ZFight.CampType)e;
                
            }
            else
            {
                val = (ZFight.CampType)objectCasters.GetCaster(typeof(ZFight.CampType))(L, index, null);
            }
        }
		
        public void UpdateZFightCampType(RealStatePtr L, int index, ZFight.CampType val)
        {
            ...
            if (LuaAPI.lua_type(L, index) == LuaTypes.LUA_TUSERDATA)
            {
                ...
                if (!CopyByValue.Pack(buff, 0,  (int)val))
                {
                    throw new Exception("pack fail for ZFight.CampType ,value="+val);
                }
            }
        ...
        int ZFightRelationType_TypeID = -1;
		int ZFightRelationType_EnumRef = -1;
        
        public void PushZFightRelationType(RealStatePtr L, ZFight.RelationType val)
        {
            if (ZFightRelationType_TypeID == -1)
            {
			    bool is_first;
                ZFightRelationType_TypeID = getTypeId(L, typeof(ZFight.RelationType), out is_first);
				
				if (ZFightRelationType_EnumRef == -1)
				{
				    Utils.LoadCSTable(L, typeof(ZFight.RelationType));
				    ZFightRelationType_EnumRef = LuaAPI.luaL_ref(L, LuaIndexes.LUA_REGISTRYINDEX);
				}
				
            }
			
			if (LuaAPI.xlua_tryget_cachedud(L, (int)val, ZFightRelationType_EnumRef) == 1)
            {
			    return;
			}
			
            IntPtr buff = LuaAPI.xlua_pushstruct(L, 4, ZFightRelationType_TypeID);
            if (!CopyByValue.Pack(buff, 0, (int)val))
            {
                throw new Exception("pack fail fail for ZFight.RelationType ,value="+val);
            }
			
			LuaAPI.lua_getref(L, ZFightRelationType_EnumRef);
			LuaAPI.lua_pushvalue(L, -2);
			LuaAPI.xlua_rawseti(L, -2, (int)val);
			LuaAPI.lua_pop(L, 1);
        ...
        public void Get(RealStatePtr L, int index, out ZFight.RelationType val)
        {
		    LuaTypes type = LuaAPI.lua_type(L, index);
            if (type == LuaTypes.LUA_TUSERDATA )
            {
			    if (LuaAPI.xlua_gettypeid(L, index) != ZFightRelationType_TypeID)
				{
				    throw new Exception("invalid userdata for ZFight.RelationType");
				}
                ...
                if (!CopyByValue.UnPack(buff, 0, out e))
                {
                    throw new Exception("unpack fail for ZFight.RelationType");
                }
				val = (ZFight.RelationType)e;
                
            }
            else
            {
                val = (ZFight.RelationType)objectCasters.GetCaster(typeof(ZFight.RelationType))(L, index, null);
            }
        }
		
        public void UpdateZFightRelationType(RealStatePtr L, int index, ZFight.RelationType val)
        {
            ...
            if (LuaAPI.lua_type(L, index) == LuaTypes.LUA_TUSERDATA)
            {
                ...
                if (!CopyByValue.Pack(buff, 0,  (int)val))
                {
                    throw new Exception("pack fail for ZFight.RelationType ,value="+val);
                }
            }
        ...
        int ZFightGameMode_TypeID = -1;
		int ZFightGameMode_EnumRef = -1;
        
        public void PushZFightGameMode(RealStatePtr L, ZFight.GameMode val)
        {
            if (ZFightGameMode_TypeID == -1)
            {
			    bool is_first;
                ZFightGameMode_TypeID = getTypeId(L, typeof(ZFight.GameMode), out is_first);
				
				if (ZFightGameMode_EnumRef == -1)
				{
				    Utils.LoadCSTable(L, typeof(ZFight.GameMode));
				    ZFightGameMode_EnumRef = LuaAPI.luaL_ref(L, LuaIndexes.LUA_REGISTRYINDEX);
				}
				
            }
			
			if (LuaAPI.xlua_tryget_cachedud(L, (int)val, ZFightGameMode_EnumRef) == 1)
            {
			    return;
			}
			
            IntPtr buff = LuaAPI.xlua_pushstruct(L, 4, ZFightGameMode_TypeID);
            if (!CopyByValue.Pack(buff, 0, (int)val))
            {
                throw new Exception("pack fail fail for ZFight.GameMode ,value="+val);
            }
			
			LuaAPI.lua_getref(L, ZFightGameMode_EnumRef);
			LuaAPI.lua_pushvalue(L, -2);
			LuaAPI.xlua_rawseti(L, -2, (int)val);
			LuaAPI.lua_pop(L, 1);
        ...
        public void Get(RealStatePtr L, int index, out ZFight.GameMode val)
        {
		    LuaTypes type = LuaAPI.lua_type(L, index);
            if (type == LuaTypes.LUA_TUSERDATA )
            {
			    if (LuaAPI.xlua_gettypeid(L, index) != ZFightGameMode_TypeID)
				{
				    throw new Exception("invalid userdata for ZFight.GameMode");
				}
                ...
                if (!CopyByValue.UnPack(buff, 0, out e))
                {
                    throw new Exception("unpack fail for ZFight.GameMode");
                }
				val = (ZFight.GameMode)e;
                
            }
            else
            {
                val = (ZFight.GameMode)objectCasters.GetCaster(typeof(ZFight.GameMode))(L, index, null);
            }
        }
		
        public void UpdateZFightGameMode(RealStatePtr L, int index, ZFight.GameMode val)
        {
            ...
            if (LuaAPI.lua_type(L, index) == LuaTypes.LUA_TUSERDATA)
            {
                ...
                if (!CopyByValue.Pack(buff, 0,  (int)val))
                {
                    throw new Exception("pack fail for ZFight.GameMode ,value="+val);
                }
            }
        ...
        int ZFightUIFormId_TypeID = -1;
		int ZFightUIFormId_EnumRef = -1;
        
        public void PushZFightUIFormId(RealStatePtr L, ZFight.UIFormId val)
        {
            if (ZFightUIFormId_TypeID == -1)
            {
			    bool is_first;
                ZFightUIFormId_TypeID = getTypeId(L, typeof(ZFight.UIFormId), out is_first);
				
				if (ZFightUIFormId_EnumRef == -1)
				{
				    Utils.LoadCSTable(L, typeof(ZFight.UIFormId));
				    ZFightUIFormId_EnumRef = LuaAPI.luaL_ref(L, LuaIndexes.LUA_REGISTRYINDEX);
				}
				
            }
			
			if (LuaAPI.xlua_tryget_cachedud(L, (int)val, ZFightUIFormId_EnumRef) == 1)
            {
			    return;
			}
			
            IntPtr buff = LuaAPI.xlua_pushstruct(L, 4, ZFightUIFormId_TypeID);
            if (!CopyByValue.Pack(buff, 0, (int)val))
            {
                throw new Exception("pack fail fail for ZFight.UIFormId ,value="+val);
            }
			
			LuaAPI.lua_getref(L, ZFightUIFormId_EnumRef);
			LuaAPI.lua_pushvalue(L, -2);
			LuaAPI.xlua_rawseti(L, -2, (int)val);
			LuaAPI.lua_pop(L, 1);
        ...
        public void Get(RealStatePtr L, int index, out ZFight.UIFormId val)
        {
		    LuaTypes type = LuaAPI.lua_type(L, index);
            if (type == LuaTypes.LUA_TUSERDATA )
            {
			    if (LuaAPI.xlua_gettypeid(L, index) != ZFightUIFormId_TypeID)
				{
				    throw new Exception("invalid userdata for ZFight.UIFormId");
				}
                ...
                if (!CopyByValue.UnPack(buff, 0, out e))
                {
                    throw new Exception("unpack fail for ZFight.UIFormId");
                }
				val = (ZFight.UIFormId)e;
                
            }
            else
            {
                val = (ZFight.UIFormId)objectCasters.GetCaster(typeof(ZFight.UIFormId))(L, index, null);
            }
        }
		
        public void UpdateZFightUIFormId(RealStatePtr L, int index, ZFight.UIFormId val)
        {
            ...
            if (LuaAPI.lua_type(L, index) == LuaTypes.LUA_TUSERDATA)
            {
                ...
                if (!CopyByValue.Pack(buff, 0,  (int)val))
                {
                    throw new Exception("pack fail for ZFight.UIFormId ,value="+val);
                }
            }
	...
	public partial class StaticLuaCallbacks
    {
	    internal static bool __tryArrayGet(Type type, RealStatePtr L, ObjectTranslator translator, object obj, int index)
		{
			...
			else if (type == typeof(ZFight.PacketType[]))
			{
			    ZFight.PacketType[] array = obj as ZFight.PacketType[];
				translator.PushZFightPacketType(L, array[index]);
				return true;
			}
			else if (type == typeof(ZFight.CampType[]))
			{
			    ZFight.CampType[] array = obj as ZFight.CampType[];
				translator.PushZFightCampType(L, array[index]);
				return true;
			}
			else if (type == typeof(ZFight.RelationType[]))
			{
			    ZFight.RelationType[] array = obj as ZFight.RelationType[];
				translator.PushZFightRelationType(L, array[index]);
				return true;
			}
			else if (type == typeof(ZFight.GameMode[]))
			{
			    ZFight.GameMode[] array = obj as ZFight.GameMode[];
				translator.PushZFightGameMode(L, array[index]);
				return true;
			}
			else if (type == typeof(ZFight.UIFormId[]))
			{
			    ZFight.UIFormId[] array = obj as ZFight.UIFormId[];
				translator.PushZFightUIFormId(L, array[index]);
				return true;
			}
            return false;
		}
