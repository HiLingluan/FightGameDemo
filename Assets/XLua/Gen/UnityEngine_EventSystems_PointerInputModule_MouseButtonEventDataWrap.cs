        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new UnityEngine.EventSystems.PointerInputModule.MouseButtonEventData();
        ...
        static int _m_PressedThisFrame(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        var gen_ret = gen_to_be_invoked.PressedThisFrame(  );
        ...
        static int _m_ReleasedThisFrame(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        var gen_ret = gen_to_be_invoked.ReleasedThisFrame(  );
                        LuaAPI.lua_pushboolean(L, gen_ret);
