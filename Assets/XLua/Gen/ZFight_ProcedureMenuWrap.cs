...
namespace XLua.CSObjectWrap
{
    ...
    public class ZFightProcedureMenuWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(ZFight.ProcedureMenu);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new ZFight.ProcedureMenu();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to ZFight.ProcedureMenu constructor!");
        ...
        static int _m_StartGame(RealStatePtr L)
        {
		    try {
                ...
                ZFight.ProcedureMenu gen_to_be_invoked = (ZFight.ProcedureMenu)translator.FastGetCSObj(L, 1);
