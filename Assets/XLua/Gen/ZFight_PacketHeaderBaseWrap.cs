...
namespace XLua.CSObjectWrap
{
    ...
    public class ZFightPacketHeaderBaseWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(ZFight.PacketHeaderBase);
        ...
        {
            return LuaAPI.luaL_error(L, "ZFight.PacketHeaderBase does not have a constructor!");
        }
        ...
        static int _m_Clear(RealStatePtr L)
        {
		    try {
                ...
                ZFight.PacketHeaderBase gen_to_be_invoked = (ZFight.PacketHeaderBase)translator.FastGetCSObj(L, 1);
