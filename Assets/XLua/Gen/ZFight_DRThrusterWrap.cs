...
namespace XLua.CSObjectWrap
{
    ...
    public class ZFightDRThrusterWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(ZFight.DRThruster);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new ZFight.DRThruster();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to ZFight.DRThruster constructor!");
        ...
        static int _m_ParseDataRow(RealStatePtr L)
        {
		    try {
                ...
                ZFight.DRThruster gen_to_be_invoked = (ZFight.DRThruster)translator.FastGetCSObj(L, 1);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to ZFight.DRThruster.ParseDataRow!");
