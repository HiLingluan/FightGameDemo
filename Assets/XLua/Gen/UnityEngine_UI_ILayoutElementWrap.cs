...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineUIILayoutElementWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			System.Type type = typeof(UnityEngine.UI.ILayoutElement);
        ...
        static int _m_CalculateLayoutInputHorizontal(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.UI.ILayoutElement gen_to_be_invoked = (UnityEngine.UI.ILayoutElement)translator.FastGetCSObj(L, 1);
