...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineEventSystemsIInitializePotentialDragHandlerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			System.Type type = typeof(UnityEngine.EventSystems.IInitializePotentialDragHandler);
        ...
        static int _m_OnInitializePotentialDrag(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.EventSystems.IInitializePotentialDragHandler gen_to_be_invoked = (UnityEngine.EventSystems.IInitializePotentialDragHandler)translator.FastGetCSObj(L, 1);
