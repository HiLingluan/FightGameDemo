...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineEventSystemsBaseInputWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 6, 8, 2);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new UnityEngine.EventSystems.BaseInput();
		    ...
		    try {
                ...
                
                {
                    int _button = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        var gen_ret = gen_to_be_invoked.GetMouseButtonDown( _button );
		    ...
		    try {
                ...
                
                {
                    int _button = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        var gen_ret = gen_to_be_invoked.GetMouseButtonUp( _button );
                        LuaAPI.lua_pushboolean(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    int _button = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        var gen_ret = gen_to_be_invoked.GetMouseButton( _button );
                        LuaAPI.lua_pushboolean(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    int _index = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        var gen_ret = gen_to_be_invoked.GetTouch( _index );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _axisName = LuaAPI.lua_tostring(L, 2);
                        ...
                        var gen_ret = gen_to_be_invoked.GetAxisRaw( _axisName );
		    ...
		    try {
                ...
                
                {
                    string _buttonName = LuaAPI.lua_tostring(L, 2);
                        ...
                        var gen_ret = gen_to_be_invoked.GetButtonDown( _buttonName );
                        LuaAPI.lua_pushboolean(L, gen_ret);
