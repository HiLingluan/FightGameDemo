...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineEventSystemsIMoveHandlerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			System.Type type = typeof(UnityEngine.EventSystems.IMoveHandler);
        ...
        static int _m_OnMove(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.EventSystems.IMoveHandler gen_to_be_invoked = (UnityEngine.EventSystems.IMoveHandler)translator.FastGetCSObj(L, 1);
