...
namespace XLua.CSObjectWrap
{
    ...
    public class ZFightNetworkChannelHelperWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(ZFight.NetworkChannelHelper);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new ZFight.NetworkChannelHelper();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to ZFight.NetworkChannelHelper constructor!");
        ...
        static int _m_Initialize(RealStatePtr L)
        {
		    try {
                ...
                ZFight.NetworkChannelHelper gen_to_be_invoked = (ZFight.NetworkChannelHelper)translator.FastGetCSObj(L, 1);
