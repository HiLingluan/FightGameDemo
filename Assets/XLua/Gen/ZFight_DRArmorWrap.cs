...
namespace XLua.CSObjectWrap
{
    ...
    public class ZFightDRArmorWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(ZFight.DRArmor);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new ZFight.DRArmor();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to ZFight.DRArmor constructor!");
        ...
        static int _m_ParseDataRow(RealStatePtr L)
        {
		    try {
                ...
                ZFight.DRArmor gen_to_be_invoked = (ZFight.DRArmor)translator.FastGetCSObj(L, 1);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to ZFight.DRArmor.ParseDataRow!");
