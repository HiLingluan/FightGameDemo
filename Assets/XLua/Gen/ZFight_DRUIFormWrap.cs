...
namespace XLua.CSObjectWrap
{
    ...
    public class ZFightDRUIFormWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(ZFight.DRUIForm);
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "AllowMultiInstance", _g_get_AllowMultiInstance);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new ZFight.DRUIForm();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to ZFight.DRUIForm constructor!");
        ...
        static int _m_ParseDataRow(RealStatePtr L)
        {
		    try {
                ...
                ZFight.DRUIForm gen_to_be_invoked = (ZFight.DRUIForm)translator.FastGetCSObj(L, 1);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to ZFight.DRUIForm.ParseDataRow!");
        ...
        static int _g_get_UIGroupName(RealStatePtr L)
        {
		    try {
                ...
                ZFight.DRUIForm gen_to_be_invoked = (ZFight.DRUIForm)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushstring(L, gen_to_be_invoked.UIGroupName);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_AllowMultiInstance(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                ZFight.DRUIForm gen_to_be_invoked = (ZFight.DRUIForm)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushboolean(L, gen_to_be_invoked.AllowMultiInstance);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_PauseCoveredUIForm(RealStatePtr L)
        {
		    try {
                ...
                ZFight.DRUIForm gen_to_be_invoked = (ZFight.DRUIForm)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushboolean(L, gen_to_be_invoked.PauseCoveredUIForm);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
