...
namespace XLua.CSObjectWrap
{
    ...
    public class ZFightCommonButtonWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(ZFight.CommonButton);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new ZFight.CommonButton();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to ZFight.CommonButton constructor!");
        ...
        static int _m_OnPointerEnter(RealStatePtr L)
        {
		    try {
                ...
                ZFight.CommonButton gen_to_be_invoked = (ZFight.CommonButton)translator.FastGetCSObj(L, 1);
