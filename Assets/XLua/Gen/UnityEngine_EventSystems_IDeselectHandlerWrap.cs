...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineEventSystemsIDeselectHandlerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			System.Type type = typeof(UnityEngine.EventSystems.IDeselectHandler);
        ...
        static int _m_OnDeselect(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.EventSystems.IDeselectHandler gen_to_be_invoked = (UnityEngine.EventSystems.IDeselectHandler)translator.FastGetCSObj(L, 1);
