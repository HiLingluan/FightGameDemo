...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineUIIMeshModifierWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			System.Type type = typeof(UnityEngine.UI.IMeshModifier);
        ...
        static int _m_ModifyMesh(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.UI.IMeshModifier gen_to_be_invoked = (UnityEngine.UI.IMeshModifier)translator.FastGetCSObj(L, 1);
