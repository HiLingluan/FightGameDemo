...
namespace XLua.CSObjectWrap
{
    ...
    public class ZFightNomalGameWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(ZFight.NomalGame);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new ZFight.NomalGame();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to ZFight.NomalGame constructor!");
        ...
        static int _m_Initialize(RealStatePtr L)
        {
		    try {
                ...
                ZFight.NomalGame gen_to_be_invoked = (ZFight.NomalGame)translator.FastGetCSObj(L, 1);
